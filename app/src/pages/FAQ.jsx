...
export default function FAQ() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: (
        <span>
          The RSVP deadline is June 1st. Please let us know if you can attend by using our <a href='/RSVP' onClick={setLocation} className='rsvpSubmit faqRSVP'>RSVP form</a>
        </span>
      )
    },
    {
